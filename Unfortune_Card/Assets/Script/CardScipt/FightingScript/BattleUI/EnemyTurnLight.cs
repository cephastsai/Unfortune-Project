...
public class EnemyTurnLight : MonoBehaviour {
	...
	void Start()
	{
		Up.transform.localPosition = new Vector3 (-1.18f,0.08f,-20);
		Down.transform.localPosition = new Vector3 (-1.18f,0.08f,-20);
	...
	void Update () 
	{
		UpDistance = Vector3.Distance (Up.transform.localPosition, new Vector3(-0.8f,0.48f,-20));
		if (Upstep1 == true) 
		{
			Up.transform.localPosition = Vector3.MoveTowards (Up.transform.localPosition , new Vector3(-0.8f,0.48f,-20) , 20*Time.deltaTime);		
		}
		...
		DownDistance = Vector3.Distance (Down.transform.localPosition, new Vector3(-1.5f,-0.32f,-20));
		if (Downstep1 == true) 
		{
			Down.transform.localPosition = Vector3.MoveTowards (Down.transform.localPosition , new Vector3(-1.5f,-0.32f,-20) , 20*Time.deltaTime);		
		}
